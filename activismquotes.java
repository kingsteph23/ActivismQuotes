...
//ali weiwei
    asianactivists.add("\"The world is not changing if you don’t shoulder the burden of responsibility.\"- ali weiwei");
    asianactivists.add("\"The world is not changing if you don’t shoulder the burden of responsibility\" -ali weiwei");
    asianactivists.add("\"Freedom is a pretty strange thing. Once you’ve experienced it, " +
                      ...
                      "\nyou can be more powerful than a whole country.\" -ali weiwei");
    asianactivists.add("\"A land that rejects the truth, barricades itself against change "+
                       "\nand lacks the spirit of freedom is hopeless.\" -ali weiwei");




//Malala Yousafzai
asianactivists.add("\"When the whole world is silent, even one voice becomes powerful.\" -Malala Yousafzai");
asianactivists.add("\"Don’t be afraid—if you are afraid you can’t move forward.\" -Malala Yousafzai");
asianactivists.add("\"Let us make our future now, and let us make our dreams tomorrow’s reality.\" -Malala Yousafzai");


int index = (int)(Math.random() * asianactivists.size());
System.out.println(asianactivists.get(index));

//Asian activist quotes
}
//americanactivists quotes
public static void americasactivists(){
    ArrayList<String> americanactivists = new ArrayList<>();
     ...
     "\nnor politic, nor popular, but he must take it because conscience tells him it is right\" -Martin Luther King Jr");
     ...
     "\nThe two are not rivals.\" -Martin Luther King Jr");

     americanactivists.add("\"Nothing in the world is more dangerous than sincere ignorance and conscientious stupidity.\" -Martin Luther King Jr");

     americanactivists.add("\"Our lives begin to end the day we become silent about things that matter.\" -Martin Luther King Jr");
  
     americanactivists.add("\"Injustice anywhere is a threat to justice everywhere\" -Martin Luther King Jr");
     

     americanactivists.add("\"We must accept finite disappointment, but never lose infinite hope.\" -Martin Luther King Jr");
    


    //james baldwin
    americanactivists.add("\"You think your pain and your "+
    "\nheartbreak are unprecedented in the history of the world, but then you read.\" -James Baldwin");
    
    americanactivists.add("\"People can cry much easier than they can change.\" -James Baldwin");
    ...
    "\nin which he is being educated.\"-James Baldwin");
       
    americanactivists.add("\"It is certain, in any case, that ignorance, allied with power, is the most ferocious enemy justice can have.\" -James Baldwin");
    ...
    "That’s when powerful interests and their lobbyists are most able to buy access and influence in the corridors of power"+
     "when– because none of us are there to speak up and stop them.\" -Barack Obama");
    
     americanactivists.add("\"the arc if the universe may bend toward justice, but it doesn't bend on its own\"");

     americanactivists.add("\"dont boo vote\" -Barack Obama");

     americanactivists.add("\"Progress will come in fits and starts"+
     "\nIts not always a straight line. Its not always smooth path.\" -Barack Obama");
     americanactivists.add("\"Change is never easy, but always possible.\" -Barack Obama");

     

    
    //malcom x
    americanactivists.add("\"A man who stands for nothing will fall for anything.\" -Malcom X");

    americanactivists.add("\"You don’t have to be a man to fight for freedom." +
    "\nAll you have to do is to be an intelligent human being.”\" -Malcom X");
    americanactivists.add("\nChange Is Only a Good Thing If You Change in a Good Way\" -Malcom X");
    ...
    //angela davis
    americanactivists.add("\"We have to talk about liberating minds as well as liberating society.\" -Angela Davis");
   
    americanactivists.add("\"It’s important to remain optimistic regardless of the situation you are facing.\" -Angela Davis");

    americanactivists.add("\"You have to believe that you can change society."+ 
    "\nYou have to do it all of the time and not just once in a while.\" -Angela Davis");
     
    americanactivists.add("\"Freeing our minds is just as important as freeing ourselves from our situations.\" -Angela Davis");
    americanactivists.add("\"In a prejudiced world, it’s better to be anti-racist than non racist.\" -Angela Davis");
    

    //cesar chavez
    americanactivists.add("\"Preservation of one’s own culture does not require contempt or disrespect for other cultures.\" -Cesar Chavez");
    ...
    "\ncounterpower, or through a  change in the hearts and minds, or change will not come.\" -Cesar Chavez");

    
    americanactivists.add("\"True wealth is not measured in money or status or power. "+
    "\nIt is measured in the legacy we leave behind for those we love and those we inspire.\" -Cesar Chavez");

    americanactivists.add("\"Once social change begins, it cannot be reversed. We have seen the future, and the future is ours.\" -Cesar Chavez");
...
System.out.println(americanactivists.get(windex));

    //end of American activist quotes
    }


    //African activism quotes
    ...
    africanactivists.add("\"As long as poverty, injustice, and gross inequality persist in our world,"+
        ...
        africanactivists.add("\"Remember that hope is a powerful weapon even when all else is lost.\" -Nelson Mandela");
        ...
        "\nagainst which I ask all humanity now to rise up.\" -Nelson Mandela");
        ...
        "\nbetween those who cherish democracy and those who do not\" -Nelson Mandela");
        ...
        "\nyou are your own Gandhi, you are your own King.\" -lemyah gbowee");

       africanactivists.add("\"The world is upside down, it's going to take a lot of hands to turn it right side up.\" -lemyah gbowee");

       africanactivists.add("\"Activism is something that no one can fake."+
       "You get angry. You cry. But you never throw in your towel, "+
       "because that anger is what is propelling you to further action.\" -lemyah gbowee");
        //desmond tutu
        africanactivists.add("\"Do your little bit of good where you are" +
                             "\nit is those little bits of good put together that overwhelm the world\"-desmond tutu");

        
       africanactivists.add("\"The price of freedom is eternal vigilance\"-desmond tutu"); 
       africanactivists.add("\"If you want peace, you don’t talk to your friends. You talk to your enemies\" -desmond tutu"); 
       africanactivists.add("\"My father used to say, don’t raise your voice; improve your argument.\" -desmond tutu");
       africanactivists.add("\"Freedom and liberty lose out by default because good people are not vigilant.\" -desmond tutu");
       africanactivists.add("\"Exclusion is never the way forward on our shared paths to freedom and justice.\" -desmond tutu");

       int mindex = (int)(Math.random() * africanactivists.size());
       System.out.println(africanactivists.get(mindex));
        //end of African method
       }
